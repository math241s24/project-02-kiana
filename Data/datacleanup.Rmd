#question: How do i save the updated/wrangled datasets as new csv's so i can call them easily in the project work file?
...
- renaming variables
```{r}
fires <- read_csv("~/Rstudio/DataScience/project-02-kiana/Data/Original_Data/fires.csv", 
...
fire_location <- read_csv("~/Rstudio/DataScience/project-02-kiana/Data/Original_Data/fire_location_data.csv")

fire_location_cleanup <- c("point_of_origin_jurisdictional_unit_identifier", 
...
fire_location <- fire_location %>%
  select(-one_of(fire_location_cleanup)) 
