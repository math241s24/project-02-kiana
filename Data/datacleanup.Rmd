...
#how to set it up so instead of my local locations its just here?
...
- renaming variables
```{r}
PAD_CA <- read_csv("../Data/PAD_CA.csv", 
...
fire_location <- read_csv("../Data/Original_Data/fire_location_data.csv")
